  ...
  return (
    <div className="min-h-screen bg-theme flex">
      ...
      >
        ...
        <h2 className="font-display text-4xl font-semibold leading-tight mb-4">Join the<br />Community.</h2>
        ...
        <div className="mt-16 grid grid-cols-2 gap-4">
          {[
            ...
            >
              ...
              <p className="text-indigo-100 text-xs mt-1">{s.label}</p>
            </motion.div>
          ))}
        </div>
      </motion.div>
      ...
      >
        <div className="w-full max-w-md">
          ...
          <h2 className="font-display text-2xl font-semibold text-primary mb-1">Create your account</h2>
          <p className="text-secondary text-sm mb-8">Join thousands of event lovers</p>
          ...
          <div className="space-y-4">
            ...
            {/* Role Selector */}
            <div>
              <label className="block text-sm font-medium text-secondary mb-2">Register as</label>
                  ...
                  <motion.button
                    ...
                    className={`py-3 rounded-xl border text-sm font-medium transition ${
                      form.role === r.val
                        ...
                        : 'border-theme text-secondary hover:border-indigo-300 bg-surface-2'
                    }`}
                  >
                    {r.label}
                  </motion.button>
